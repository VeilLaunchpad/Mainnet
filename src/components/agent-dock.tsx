...
export function AgentDock() {
  ...
  return (
    <>
      ...
      <button
        onClick={() => setOpen((v) => !v)}
        className="btn-primary fixed bottom-4 right-4 z-50 flex items-center gap-2 rounded-full px-3.5 py-2.5 text-[13px] shadow-lg shadow-devox-500/25 sm:bottom-5 sm:px-4 sm:py-3"
      >
